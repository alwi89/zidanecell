<html>
	<head>
    	<title>laporan return cabang periode <?php echo $_POST['rkcdari']; ?> s/d <?php echo $_POST['rkcsampai']; ?></title>
    </head>
    <body onLoad="javascript:print();">
    	<div>
        	<div style="font-size:18px"><b>Laporan Return Cabang<br />Periode : <?php echo $_POST['rkcdari']; ?> s/d <?php echo $_POST['rkcsampai']; ?><br />Zidane Cell</b></div><hr />
