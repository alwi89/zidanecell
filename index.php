...
*/
    ...
    var table_cart_kc;
    var table_cart_ec;
    var table_cart_grosir;
    var table_cart_rgr;
    var table_cart_rec;
    var table_cart_rkc;
	function page(halaman, judul){
		if($('#'+halaman).length==0){
			$('#pageTab').append('<li><a href="#'+halaman+'" data-toggle="tab">'+judul+'&nbsp;<button class="close" type="button" >x</button></a></li>');
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="#" onClick="page('lap_grosir_marketing', 'Laporan Grosir Permarketing')"><i class="fa fa-circle-o"></i> Grosir Permarketing</a></li>
